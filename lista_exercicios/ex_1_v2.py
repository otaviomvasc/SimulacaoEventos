...
from Modelos import Estatistica_v1, Entidades,Entidade_individual, Recursos, CorridaSimulacao, Simulacao, EstatisticasSistema
...
if __name__ == '__main__':
    ...
    Corrida_Simulacao.fecha_estatisticas_experimento()
